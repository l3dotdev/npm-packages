...
Date.prototype.isToday = function (this: Date) {
	return new Date(this).setHours(0, 0, 0, 0) == new Date().setHours(0, 0, 0, 0);
};

Date.prototype.isTomorrow = function (this: Date) {
	return (
...
Date.prototype.isYesterday = function (this: Date) {
	return (
		new Date(this).setHours(0, 0, 0, 0) ==
		new Date(Date.now() - 24 * 3600 * 1000).setHours(0, 0, 0, 0)
	);
